...
\href{mailto:ppj@zemris.fer.hr}{ppj@zemris.fer.hr}
}
\date{
\vspace{30pt} 
...
Iznimno, između nekih predavanja će doći do pauze zbog održavanja auditornih vježbi u terminima predavanja ili neradnih dana.
...
Tijekom semestra provode se pismene provjere znanja: dva međuispita i završni ispit. Trajanje svakog od međuispita i završnog ispita je 2 sunčana sata. Svaki međuispit i završni ispit sastoji se od 10 zadataka (5 teoretskih pitanja i 5 problemskih zadataka).

\textbf{Prvi međuispit} \\
Tjedan održavanja: 14.~11.~2011.~–- 25.~11.~2011. \\
Udio u ukupnoj ocjeni: K1 = 10 bodova \\
Gradivo: Gradivo do (uključujući i) S-gramatiku.

\textbf{Drugi međuispit} \\
Tjedan održavanja: 19.~12.~2011.~–- 23.~12.~2011. \\
Udio u ukupnoj ocjeni: K2 = 20 bodova \\
Gradivo: Gradivo do (uključujući i) poglavlja 4.3.5. -- Metoda rekurzivnog spusta za zadanu L-atributnu prijevodnu gramatiku, uključujući gradivo prvog ciklusa predavanja.
...
Tijekom svake nastavne cjeline provode se kratke provjere znanja (po jedna provjera u svakoj nastavnoj cjelini) putem Ahyco sustava u laboratorijima FER-a.
...
Studenti imaju pravo uvida u rezultate pismenih provjera znanja: međuispiti, završni ispit, kratke provjere znanja i ispiti na ispitnim rokovima.
...
Studenti koji nisu u mogućnosti doći na uvid, ali isključivo iz opravdanog razloga, trebaju se barem jedan dan unaprijed porukom na službenu e-mail adresu predmeta najaviti s terminom u kojemu mogu doći na uvid.
...
Na početku semestra nastavnici definiraju koordinatore grupa za laboratorijske vježbe na temelju rezultata iz predmeta "Uvod u teoriju računarstva" protekle akademske godine.
Koordinatori grupa potrebni su samo za formiranje grupa za laboratorijske vježbe. 
...
Postoje četiri predaje laboratorijskih vježbi putem računala te dvije usmene predaje ispitivanjem.
...
Na usmenu predaju grupa treba donijeti računalo na kojemu će moći pokazati rezultate laboratorijske vježbe.
...
Na usmenoj predaji ocjenjuje se znanje studenata vezano uz dijelove jezičnog procesora koje je grupa programski ostvarila te gradivo predavanja vezano uz cjeline laboratorijskih vježbi.
Na usmenoj predaji studente se ocjenjuje pojedinačno; na svakoj usmenoj predaji moguće je ostvariti najviše 5 bodova.
...
Primjerice, ako je student iz svih usmenih predaja dobio ukupno 7.5 od 10 bodova, onda od voditelja za predaju putem računala može dobiti ukupno najviše 7.5 + 5 = 12.5 od 15 bodova. 
...
Dodatno, na drugoj usmenoj predaji, voditeljima se dodjeljuje najviše 1 * broj\_studenata\_u\_grupi bodova za uspjeh u integraciji rješenja pojedinih ciklusa laboratorijskih vježbi u cjeloviti jezični procesor.
...
Također, na drugoj usmenoj predaji, isključivo voditeljima dodjeljuje se do 5 bodova za njihov uspjeh u vođenju grupe, pri čemu se 3 od 5 bodova određuje anonimnim glasanjem članova grupe, a 2 od 5 bodova određuju nastavnici.
...
Primjerice, studente se potiče na sudjelovanje u diskusijama tijekom predavanja (na svakom predavanju studenta se može usmeno ispitati), prijavu mogućih pogrešaka u nastavnim materijalima ili konkretnih konstruktivnih prijedloga za njihovo unapređenje (udžbenik, skripta sa zadacima, upute za laboratorijske vježbe i ove upute) te prijavu mogućih grešaka u računalnim sustavima koji se koriste za provedbu laboratorijskih vježbi.
Ako više studenata prijavi istu pogrešku ili prijedlog, mogući bodovi dodijeliti će se samo studentu koji je prvi prijaviopogrešku ili prijedlog.
...
Kazna za studente prekrše kodeks ponašanja jest 0 bodova iz provjere za koju se utvrdilo kršenje kodeksa te prijava disciplinskoj komisiji.
...
Nadoknade kratkih provjera znanja i usmenih predaja laboratorijskih vježbi moguće su isključivo iz opravdanih razloga te isključivo i bez izuzetaka uz predočenje pismene dokumentacije koja potvrđuje opravdanost razloga izostanka.
Studentima koji nemaju pismenu dokumentaciju koja opravdava njihov izostanak neće biti omogućem pristup nadoknadama.
...
Ukupna ocjena određuje se na temelju izračunatih BODOVA:
\begin{myindentpar}{30pt}
...
Ukupna ocjena na predmetu za studente koji pristupaju ispitnom roku određuje se na temelju ostvarenih BODOVA:
\begin{myindentpar}{30pt}
Dovoljan: 50 bodova \\
Dobar: 63 bodova \\
